...
const CVScoring = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a, b) =>
        (a.aiScore || a.score || 0) - (b.aiScore || b.score || 0),
    },
    {
      title: "Trạng thái",
      key: "status",
      ...
      render: (_, record) => {
        ...
        return (
          <Tag
            color={c.color}
            icon={c.color === "green" ? <CheckCircleOutlined /> : null}
          >
            {c.label}
          </Tag>
        );
    ...
    <div className="cv-scoring-page">
      <div className="page-header">
        <div>
          ...
          <Text type="secondary">
            Sử dụng AI để chấm điểm và xếp hạng ứng viên theo mức độ phù hợp
          </Text>
        </div>
        <Space>
          <Select
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ textAlign: "right", flexShrink: 0 }}>
                      <TrophyOutlined
                        style={{ color: colors[idx], fontSize: 20 }}
                      />
                      <div
                        style={{
                          fontWeight: 800,
        ...
        {loading ? (
          <div style={{ textAlign: "center", padding: 60 }}>
            ...
            <div style={{ marginTop: 16 }}>
              <Text type="secondary">Đang chấm điểm CV...</Text>
            </div>
          </div>
        ) : ranking.length > 0 ? (
          <Table
          ...
          <Empty
            ...
            description={
              <div>
                ...
                <br />
                <Text type="secondary" style={{ fontSize: 12 }}>
                  Upload CV hoặc chọn vị trí để xem xếp hạng
                </Text>
              </div>
            }
          />
            ...
            <Tabs
              items={[
                        ...
                        <Col span={12}>
                          ...
                          >
                            <Statistic
                              title="Điểm tổng"
                              value={
                                selectedCV.totalScore || selectedCV.aiScore || 0
                              }
                              suffix="%"
                              valueStyle={{
                                color: getScoreColor(selectedCV.totalScore),
                                fontSize: 28,
                              }}
                        ...
                        <Col span={12}>
                          ...
                          >
                            <Statistic
                              title="Kỹ năng khớp"
                              value={
                                selectedCV.matchedSkillsCount ||
                                (selectedCV.matchedSkills || []).length
                              }
                ...
                },
                {
                  ...
                  children: (
                    <div>
                      {(selectedCV.evaluation || selectedCV.scores || []).map(
                        (item, idx) => (
                          <div
                            key={idx}
                            style={{
