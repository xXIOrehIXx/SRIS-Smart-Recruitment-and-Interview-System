...
const DeptInterviewDetail = () => {
    ...
    interviewers: [
      {
        ...
        role: "Technical Lead",
        score: 8,
        feedback: "Ứng viên có kiến thức vững về React và TypeScript.",
      },
      {
        name: "Lê Thị B",
        role: "Senior Engineer",
        score: 7,
        feedback: "Kỹ năng problem-solving tốt, giao tiếp rõ ràng.",
      },
    ],
  ...
  const avgScore =
    interview.interviewers.reduce((sum, i) => sum + i.score, 0) /
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          ...
          <Text
            strong
            style={{ marginLeft: 8, color: getScoreColor(record.score * 2) }}
          >
            {record.score}/5
          </Text>
        </div>
      ...
      <div className="page-header">
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <Button
            ...
            onClick={() => navigate("/dept/interviews")}
          />
          <div>
            ...
            <Text type="secondary">
              {dayjs(interview.scheduledDate).format("DD/MM/YYYY")} lúc{" "}
              {interview.scheduledTime} • Vòng {interview.level}/
              {interview.totalLevel}
            </Text>
          </div>
        </div>
        <Space>
        ...
        <Col xs={24} lg={16}>
          ...
          >
            ...
            >
              ...
              <Tag
                color={
                  interview.status === "COMPLETED" ? "success" : "processing"
                }
                style={{ fontSize: 14 }}
              >
            ...
            <Descriptions column={2} bordered size="small">
              ...
              <Descriptions.Item label="Vòng phỏng vấn">
                Vòng {interview.level} / {interview.totalLevel}
              </Descriptions.Item>
          ...
          >
            ...
            <div style={{ textAlign: "center", marginTop: 20 }}>
              ...
              >
                <Text
                  strong
                  style={{ fontSize: 32, color: getScoreColor(avgScore) }}
                >
                  {avgScore.toFixed(1)}
                </Text>
              </div>
          ...
          <Card className="main-card" bordered={false}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <Text>
                  {dayjs(interview.scheduledDate).format("dddd, DD/MM/YYYY")}
                </Text>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
