            ...
            subTitle={
              <div>
                ...
                <p style={{ marginTop: 8, color: "#666" }}>
                  Chúng tôi sẽ gửi email xác nhận kèm lịch phỏng vấn chi tiết
      ...
      <Layout className="schedule-layout">
        ...
        <Content className="sch-content">
          <Result
            ...
            icon={
              <ClockCircleOutlined
                style={{ color: MATCHA_GREEN, fontSize: 72 }}
              />
            }
            ...
            subTitle={
              <div>
                ...
                <p style={{ marginTop: 8, color: "#666" }}>
                  Bộ phận tuyển dụng sẽ liên hệ với bạn để sắp xếp lịch phỏng
                  vấn khác.
                </p>
              </div>
            }
        ...
        <div className="sch-container">
          <div className="sch-hero">
            ...
            <Paragraph className="sch-hero-subtitle">
              Vui lòng chọn một khung giờ phỏng vấn phù hợp với bạn. Sau khi xác
              nhận, bạn sẽ nhận được email xác nhận kèm lịch chi tiết.
            </Paragraph>
          </div>
                      ...
                      <Radio value={slot.slotId}>
                        <div className="sch-slot-content">
                          ...
                          <div className="sch-slot-time">
                            <ClockCircleOutlined /> {formatTime(slot.startTime)}{" "}
                            - {formatTime(slot.endTime)}
                          </div>
                          {slot.interviewerName && (
                            <div className="sch-slot-interviewer">
                              <UserOutlined /> Người phỏng vấn:{" "}
                              {slot.interviewerName}
                            </div>
                          )}
                        </div>
          ...
          <Text type="secondary" className="sch-footer-note">
            Nếu bạn cần hỗ trợ thêm, vui lòng liên hệ bộ phận nhân sự qua email
            hoặc số điện thoại được cung cấp trong email gốc.
          </Text>
        </div>
      </Content>
