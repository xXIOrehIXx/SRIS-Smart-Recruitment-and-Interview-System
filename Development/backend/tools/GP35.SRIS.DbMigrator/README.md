...
- RLS được viết SQL tay trong V001 — đó là lý do dùng DbUp (chạy raw SQL). V001 còn có cột
  `VECTOR(1024)`: đó là lịch sử, V036 đã drop hẳn. Migration cũ KHÔNG sửa lại, chỉ thêm bản mới.
