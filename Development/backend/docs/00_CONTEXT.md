...
| **Giám đốc** (V043) | Người quyết tuyển | Đăng nhập Portal | Duyệt/không duyệt Đề xuất tuyển của DM — **duyệt = chốt mức lương** (điền sẵn mức DM đề xuất, sửa được — V057); phạm vi toàn công ty |
...
- **Ai chạm hồ sơ (sửa sau bảo vệ hội đồng 15/08/2026 — DM có HAI cửa):**
  ...
  - `INTERVIEW→OFFER` — **cửa của GIÁM ĐỐC: quyết tuyển** (chốt 15/08/2026, V043). Trưởng bộ phận KHÔNG đủ thẩm quyền tuyển: họ đọc đề xuất panel rồi gửi **phiếu Đề xuất tuyển** (`HiringProposal`); Giám đốc duyệt — chính hành động duyệt đó đẩy hồ sơ sang OFFER kèm mức lương Giám đốc chốt (V057, đảo V053: ô lương điền sẵn mức DM đề xuất, Giám đốc giữ nguyên hoặc sửa ngay lúc duyệt — không phải trả phiếu về chờ DM gõ lại. Ngày vào làm nhập ở thư mời — V051). Giám đốc có phạm vi TOÀN CÔNG TY, không gán theo vị trí. Không duyệt ≠ loại: hồ sơ ở lại INTERVIEW, DM đề xuất lại được.
...
- **Luồng:** DM gửi Đề xuất tuyển KÈM mức lương → **Giám đốc duyệt và chốt mức lương — giữ mức đề xuất hoặc sửa ngay** (V057; duyệt → hồ sơ sang OFFER; chưa duyệt → phiếu về DM kèm lý do) → HR soạn thư (ô lương KHOÁ theo mức Giám đốc chốt, ngày vào làm HR tự điền sau khi gọi ứng viên — V051; phần còn lại lấy từ Job/Company, phần còn lại lấy từ Job/Company, sửa được) → lưu `OfferDetail` (PENDING) + gửi email → ứng viên trả lời NGOÀI hệ thống → HR bấm "Đã nhận việc"/"Từ chối" trong Portal → ACCEPTED+HIRED (kèm email onboarding) / DECLINED+REJECTED.
...
- Lưu ý cốt lõi:
  ...
  - Chấm vs đề xuất vs quyết (5.7, 5.14): phiếu ẩn tới khi nộp; interviewer nêu đề xuất tuyển; DM đọc **đề xuất chứ không đọc điểm**, duyệt ai vào phỏng vấn (SCREENING→INTERVIEW) rồi **gửi Đề xuất tuyển**; **GIÁM ĐỐC quyết tuyển** (INTERVIEW→OFFER) và chốt mức lương (sửa được mức DM đề xuất — V057); HR sàng lọc + đặt lịch + soạn thư (điền ngày vào làm). `reject_reason` tùy chọn.
